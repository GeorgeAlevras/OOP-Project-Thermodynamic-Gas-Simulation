...
"""
    This file checks the pressure laws for a gas with 'balls' of half the size of a hydrogen atom.
...
# In this package the 'balls' are half the size of a hydrogen atom
...
number_of_balls = 100
radius_of_balls = 2.65e-11  # In units of m
...
plt.savefig('pressure_against_T_H0_5.png')
...
plt.plot(container_area_inverse, p_phase_1(container_area_inverse), color='k',
         label='gradient = ' + str(round(fit_phase_1[0], 6)) + "+-" + str(round(cov_phase_1[0][0], 9)))
...
plt.savefig('pressure_against_V_H0_5.png')
...
plt.plot(number_of_balls, p_phase_2(number_of_balls), color='k',
         label='gradient = ' + str(round(fit_phase_2[0], 6)) + "+-" + str(round(cov_phase_2[0][0], 9)))
...
plt.savefig('pressure_against_N_H0_5.png')
