...
"""
    This file checks the pressure laws for a gas with 'balls' of twice the size of a hydrogen atom.
...
number_of_balls = 100
radius_of_balls = 1.06e-10  # In units of m
...
plt.savefig('pressure_against_T_H2.png')
...
plt.savefig('pressure_against_V_H2.png')
...
plt.savefig('pressure_against_N_H2.png')
